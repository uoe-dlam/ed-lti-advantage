 ...
 *
 *    $ssh = new \UoEDLAM\Vendor\phpseclib\Net\SSH1('www.domain.tld');
...
use UoEDLAM\Vendor\phpseclib\Crypt\DES;
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::bitmap
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH1::read()
    */
    /**
     ...
     * @param int $timeout
     * @param int $cipher
     * @return \UoEDLAM\Vendor\phpseclib\Net\SSH1
     * @access public
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \UoEDLAM\Vendor\phpseclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \UoEDLAM\Vendor\phpseclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \UoEDLAM\Vendor\phpseclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
