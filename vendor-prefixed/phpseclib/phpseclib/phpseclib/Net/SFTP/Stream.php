...
namespace UoEDLAM\Vendor\phpseclib\Net\SFTP;

use UoEDLAM\Vendor\phpseclib\Crypt\RSA;
use UoEDLAM\Vendor\phpseclib\Net\SFTP;
...
class Stream
{
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \UoEDLAM\Vendor\phpseclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
