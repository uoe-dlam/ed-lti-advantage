 ...
 *
 *    $ssh = new \UoEDLAM\Vendor\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \UoEDLAM\Vendor\phpseclib\Crypt\RSA();
...
use UoEDLAM\Vendor\phpseclib\Crypt\Base;
use UoEDLAM\Vendor\phpseclib\Crypt\Blowfish;
use UoEDLAM\Vendor\phpseclib\Crypt\Hash;
use UoEDLAM\Vendor\phpseclib\Crypt\Random;
use UoEDLAM\Vendor\phpseclib\Crypt\RC4;
use UoEDLAM\Vendor\phpseclib\Crypt\Rijndael;
use UoEDLAM\Vendor\phpseclib\Crypt\RSA;
use UoEDLAM\Vendor\phpseclib\Crypt\TripleDES;
use UoEDLAM\Vendor\phpseclib\Crypt\Twofish;
use UoEDLAM\Vendor\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use UoEDLAM\Vendor\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \UoEDLAM\Vendor\phpseclib\Net\SSH2
     * @access public
     */
     ...
     *
     * @param string $username
     * @param \UoEDLAM\Vendor\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \UoEDLAM\Vendor\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
