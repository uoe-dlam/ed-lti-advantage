 ...
 *
 *    $sftp = new \UoEDLAM\Vendor\phpseclib\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SFTP::put()
    */
    /**
     ...
     * @param int $port
     * @param int $timeout
     * @return \UoEDLAM\Vendor\phpseclib\Net\SFTP
     * @access public
     */
     ...
     *
     * By default, \UoEDLAM\Vendor\phpseclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
