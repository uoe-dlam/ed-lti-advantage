 ...
 *        exit('bad login');
 *    }
 *    $scp = new \UoEDLAM\Vendor\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \UoEDLAM\Vendor\phpseclib\Net\SCP::_send()
     * @see \UoEDLAM\Vendor\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \UoEDLAM\Vendor\phpseclib\Net\SSH1|\UoEDLAM\Vendor\phpseclib\Net\SSH2 $ssh
     * @return \UoEDLAM\Vendor\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \UoEDLAM\Vendor\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
