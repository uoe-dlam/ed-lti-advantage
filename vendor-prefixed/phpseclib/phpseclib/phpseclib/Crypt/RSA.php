 ...
 *
 *    $rsa = new \UoEDLAM\Vendor\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::createKey()
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     ...
     * Precomputed Zero
     *
     * @var \UoEDLAM\Vendor\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \UoEDLAM\Vendor\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     *
     * @return \UoEDLAM\Vendor\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     * @access private
     * @param \UoEDLAM\Vendor\phpseclib\Math\BigInteger $x
     * @param \UoEDLAM\Vendor\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \UoEDLAM\Vendor\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \UoEDLAM\Vendor\phpseclib\Math\BigInteger $m
     * @return \UoEDLAM\Vendor\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \UoEDLAM\Vendor\phpseclib\Math\BigInteger $c
     * @return \UoEDLAM\Vendor\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \UoEDLAM\Vendor\phpseclib\Math\BigInteger $s
     * @return \UoEDLAM\Vendor\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
