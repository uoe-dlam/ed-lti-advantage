 ...
 *
 *    $des = new \UoEDLAM\Vendor\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::block_size
     * @var int
     * @access private
     */
    var $block_size = 8;
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
     ...
     * Encrypts a block
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::_encryptBlock()
     ...
     * Decrypts a block
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::_decryptBlock()
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::_setupInlineCrypt()
     * @access private
     */
