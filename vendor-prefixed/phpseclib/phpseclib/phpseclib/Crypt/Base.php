...
abstract class Base
{
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Twofish::setKey()
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \UoEDLAM\Vendor\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
