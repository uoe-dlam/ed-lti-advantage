 ...
 *
 *    $hash = new \UoEDLAM\Vendor\phpseclib\Crypt\Hash('sha1');
 *
 *    $hash->setKey('abcdefg');
 *
...
class Hash
{
    /**#@+
     * @access private
     * @see \UoEDLAM\Vendor\phpseclib\Crypt\Hash::__construct()
     */
    /**
     ...
     *
     * @param string $hash
     * @return \UoEDLAM\Vendor\phpseclib\Crypt\Hash
     * @access public
     */
    ...
    function _sha512($m)
    {
        ...
        // Produce the final hash value (big-endian)
        // (\UoEDLAM\Vendor\phpseclib\Crypt\Hash::hash() trims the output for hashes but not for HMACs.  as such, we trim the output here)
