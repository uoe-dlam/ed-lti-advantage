...
use UoEDLAM\Vendor\phpseclib\File\ASN1\Element;
use UoEDLAM\Vendor\phpseclib\Math\BigInteger;
use DateTime;
use DateTimeZone;
...
class X509
{
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\File\X509::getDN()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \UoEDLAM\Vendor\phpseclib\File\X509::saveX509()
     * @see \UoEDLAM\Vendor\phpseclib\File\X509::saveCSR()
     * @see \UoEDLAM\Vendor\phpseclib\File\X509::saveCRL()
    */
    /**
     * Save as PEM
     *
     ...
     * Default Constructor.
     *
     * @return \UoEDLAM\Vendor\phpseclib\File\X509
     * @access public
     */
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \phpseclib\File\ASN1::TYPE_IA5_STRING.
           \UoEDLAM\Vendor\phpseclib\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
     ...
     *
     * @param \UoEDLAM\Vendor\phpseclib\File\X509 $issuer
     * @param \UoEDLAM\Vendor\phpseclib\File\X509 $subject
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(array('\UoEDLAM\Vendor\phpseclib\File\X509', '_dnsName'), $subject->domains);
        }
     ...
     *
     * @param \UoEDLAM\Vendor\phpseclib\File\X509 $issuer
     * @param \UoEDLAM\Vendor\phpseclib\File\X509 $crl
     * @param string $signatureAlgorithm optional
     * @access public
     * @return mixed
     */
     ...
     *
     * @param \UoEDLAM\Vendor\phpseclib\File\X509 $key
     * @param string $signatureAlgorithm
     * @access public
     * @return mixed
     */
    ...
    function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \UoEDLAM\Vendor\phpseclib\Crypt\RSA).
